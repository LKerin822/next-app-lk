    ...
    <Container id='about'>
      ...
      <Col md={5}>
        ...
        <p>Hi, I'm Louise Kerin. I am an artist and designer based in Langwarrin, on the Mornington Peninsula, in Victoria.  
          ...
          <br></br>
          <br></br>My design journey has taken me to studying for a Bachelor degree online with Curtin University. Should everything run smoothly, I should graduate later this year with a Bachelor of Arts: (Digital Experience and Interaction Design) and (Professional Writing and Publishing).</p>
        </Col>
